    ...
    for epoch in range(num_epochs):
        ...
        for batch_idx, ((source_data, source_labels, source_snr),
            ...
            if loss.item() < best_loss:
                best_loss = loss.item()
                torch.save(encoder.state_dict(), f"../autodl-tmp/uda/{da_dataset}/sdidn_cnn_pretrain/" + f'pretrained_sdidn_encoder.pth')
                torch.save(decoder.state_dict(), f"../autodl-tmp/uda/{da_dataset}/sdidn_cnn_pretrain/" + f'pretrained_sdidn_decoder.pth')
