...
def run_eval(source_train_loader, target_train_loader, da_dataset: str, model_name: str, seq: int):
...
if __name__ == "__main__":
    ...
    for i in range(5):
        run_eval(source_train_loader, target_train_loader, "16a_22", "sdidn", i)