...
from model.distan_dann import DISTAN_G, HighFidelitySignalDecoder
    ...
    for epoch in range(num_epochs):
        ...
        for batch_idx, ((source_data, source_labels, source_snr),
            ...
            if loss.item() < best_loss:
                best_loss = loss.item()
                torch.save(encoder.state_dict(), 'pretrained_distan_encoder.pth')
                torch.save(decoder.state_dict(), 'pretrained_distan_decoder.pth')
