...
def run_train():
    ...
    batch_size = 512
    train_loader, valid_loader = DataloaderHelper.dataloader_22(batch_size)
    ...
    train_and_evaluate(model, train_loader, valid_loader, optimizer, criterion_ce,
                       device, 50, "cnn1d_22_all")
